...
(defun make-matrix (n1 n2 &key (element-type :t)
...
(defclass matrix-double-view (matrix-t-view) ())

(defclass matrix-float-view (matrix-t-view) ())

(defclass matrix-int-view (matrix-t-view) ())

(defclass matrix-uint-view (matrix-t-view) ())
...
(defmethod matrix-coerce ((m matrix-t) element-type)
...
(defmethod matrix-get ((m matrix-t) i j)
  (cond ((>= i (size1 m))
...
(defmethod matrix-set ((m matrix-t) i j x)
  (cond ((>= i (size1 m))
         (error "first index out of range"))
        ((>= j (size2 m))
         (error "second index out of range"))
...
(defmethod matrix-set-all ((m matrix-t) x)
  (dotimes (i (size1 m) m)
    (dotimes (j (size2 m))
      (setf (aref (data m) (+ (* i (tda m)) j)) x))))
...
(defun matrix-view-array (base n1 n2 &key (element-type :t))
...
(defmethod matrix-copy ((dest matrix-t) (src matrix-t))
...
(defmethod matrix-get-row ((v vector-t) (m matrix-t) i)
  (cond
    ((>= i (size1 m))
     (error "row index is out of range"))
    ((not (= (size v) (size2 m)))
...
(defmethod matrix-set-row ((m matrix-t) i (v vector-t))
  (cond
    ((>= i (size1 m))
     (error "row index is out of range"))
    ((not (= (size v) (size2 m)))
...
(defmethod matrix-get-col ((v vector-t) (m matrix-t) j)
  (cond
    ((>= j (size2 m))
     (error "column index is out of range"))
    ((not (= (size v) (size1 m)))
...
(defmethod matrix-set-col ((m matrix-t) j (v vector-t))
  (cond
    ((>= j (size2 m))
     (error "column index is out of range"))
    ((not (= (size v) (size1 m)))
...
(defmethod matrix-swap-rows ((m matrix-t) i j)
  (cond
    ((>= i (size1 m))
...
(defmethod matrix-swap-columns ((m matrix-t) i j)
  (cond
    ((>= i (size2 m))
...
(defmethod matrix-transpose ((dest matrix-t) (src matrix-t))
...
(defmethod matrix-add ((a matrix-t) (b matrix-t))
...
(defmethod matrix-sub ((a matrix-t) (b matrix-t))
  (if (or (not (= (size1 b) (size1 a)))
          (not (= (size2 b) (size2 a))))
      (error "matrices must have same dimensions")
      (dotimes (i (size1 a) a)
...
(defmethod matrix-mul-elements ((a matrix-t) (b matrix-t))
  (if (or (not (= (size1 b) (size1 a)))
          (not (= (size2 b) (size2 a))))
      (error "matrices must have same dimensions")
      (dotimes (i (size1 a) a)
...
(defmethod matrix-div-elements ((a matrix-t) (b matrix-t))
  (if (or (not (= (size1 b) (size1 a)))
          (not (= (size2 b) (size2 a))))
      (error "matrices must have same dimensions")
      (dotimes (i (size1 a) a)
...
(defmethod matrix-scale ((a matrix-t) x)
  (dotimes (i (size1 a) a)
    (dotimes (j (size2 a))
      (setf (aref (data a) (+ (* i (tda a)) j))
...
(defmethod matrix-add-constant ((a matrix-t) x)
  (dotimes (i (size1 a) a)
    (dotimes (j (size2 a))
      (setf (aref (data a) (+ (* i (tda a)) j))
            (+ (aref (data a) (+ (* i (tda a)) j)) x)))))
...
(defmethod matrix-max ((m matrix-t))
  (reduce #'max (data m)))
...
(defmethod matrix-min ((m matrix-t))
  (reduce #'min (data m)))
...
(defmethod matrix-minmax ((m matrix-t))
...
(defmethod matrix-max-index ((m matrix-t))
...
(defmethod matrix-minmax-index ((m matrix-t))
...
(defmethod matrix-read ((m matrix-t)
...
;; matrix-t print-object
(defmethod print-object ((m matrix-t) stream)
  (print-matrix m stream)
  (call-next-method))

;; matrix-t-view print-object
(defmethod print-object ((view matrix-t-view) stream)
