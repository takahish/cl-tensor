...
;;;; probability distributions. Samples from the distributions described in
;;;; this file can be obtained using any of the random number generators in
;;;; the library as an underlying source of randomness.
